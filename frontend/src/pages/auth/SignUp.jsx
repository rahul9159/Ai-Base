            ...
            <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="hidden lg:block">
                    <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
                        <h2 className="text-4xl font-bold mb-6">Start creating with AI today</h2>
                        <p className="text-lg mb-8 opacity-90">
                            Join thousands of creators using AI-Base to bring their ideas to life.
                        </p>
                        ...
                        <div className="mt-12 p-6 bg-white/10 rounded-2xl backdrop-blur-sm">
                            <p className="text-sm opacity-90 italic">
                                "AI-Base has transformed how we create content. The tools are incredibly powerful yet easy to use."
                            </p>
                            <p className="mt-3 font-semibold">— Sarah M., Content Creator</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-md w-full mx-auto">
                    ...
                    <p className="mt-6 text-center text-gray-600">
                        ...
                        <Link to="/signin" className="text-blue-600 hover:text-purple-600 font-semibold">
                            Sign in
                        </Link>
                    </p>
                </div>
